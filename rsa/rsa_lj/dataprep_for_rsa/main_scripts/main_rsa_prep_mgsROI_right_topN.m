...
rootOutDir = '/gpfs/scratch/linjjiang/scan_data/rsa/full_GLM_mgs_topN_right/';
...
roiDir = '/gpfs/scratch/linjjiang/atlases/final_atlas_roi/rsa_mgs1_conj_mgs2_topN_right';

roi_pfix = 'mgs_dil_custom_*'; % 'mgs_'; 'mgs_close_'; 'mgs_75_'; 'mgs_55_close_';
%roi_names = {'v1', 'v2', 'area4', 'fef', 'sfg', 'mfg', 'ifg', 'ips',...
%    'ips0', 'ips1', 'ips2', 'ips3', 'ips4', 'ips5', 'spl1'};
roi_names = {'r-v1', 'r-v2', 'r-area4', 'r-fef', 'r-sfg', 'r-mfg', 'r-ifg', 'r-ips',...
    'r-ips0', 'r-ips1', 'r-ips2', 'r-ips3', 'r-ips4', 'r-ips5', 'r-spl1'};
